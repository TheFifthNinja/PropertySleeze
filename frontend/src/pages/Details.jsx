...
export default function Details({ darkMode, renter }) {
  ...
  useEffect(() => {
      setIsLoading(true);
      fetch('https://api.propertysleeze.shop/property/'+address, {
         method: 'GET',
      })
      .then((res) => {
          if (!res.ok) {
        ...
        setProduct({
            ...
            price: '$'+data.rent,
            images: {
                src: 'https://api.propertysleeze.shop/pictures/'+data.picture,
                alt: data.picture,
            },
  ...
  const handleRent = () => {
    ...
    fetch('https://api.propertysleeze.shop/renting', {
      method: 'POST',
      headers: {
